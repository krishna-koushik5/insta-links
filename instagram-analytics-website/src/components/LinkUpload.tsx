            ...
            <form onSubmit={handleSubmit} className="space-y-4" role="form">
                <div className="space-y-4">
                    ...
                    <textarea
                        ...
                        rows={3}
                        className="w-full py-3 px-4 bg-gray-800 border border-gray-700 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-instagram-500 focus:border-transparent resize-none"
                        disabled={isUploading}
                    />
                    ...
                    <select
                        ...
                        className="w-full py-3 px-4 bg-gray-800 border border-gray-700 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-instagram-500 focus:border-transparent"
                        disabled={isUploading}
                    >
